...
\begin{figure}
  ...
  \caption[Transfer functions from various mirrors in the \SSMEXPT{} to the balanced homodyne port]{\label{fig:ssm-mirror-tfs}blah}
\end{figure}
...
\begin{figure}
  ...
  \caption[Effective \LMINUS{} seismic noise contribution from \MSEVEN{}]{\label{fig:m7-seismic-noise}blah... this assumes coupling of 1\%, uses seismic noise propagated to tables from ground, etc. The sensitivity requirement is given only for frequencies above \SI{100}{\hertz} where the measurement of reduced radiation pressure noise will be made.}
\end{figure}
...
\begin{figure}
  ...
  \caption[Simplified layout of the \SSMEXPT{} including a basic velocity feedback loop]{\label{fig:simplified-speedmeter-layout-velocity}blah}
\end{figure}
...
\begin{figure}
  ...
  \caption[The frequency response of the differential arm cavity degree of freedom to the balanced homodyne readout]{\label{fig:bhd-response}blah}
\end{figure}
...
\begin{figure}
  ...
  \caption[Electronic schematic for the balanced homodyne readout]{\label{fig:bhd-electronics}blah}
\end{figure}
...
\begin{figure}
  ...
  \caption[Electronic schematic for the measurement of noise from the balanced homodyne readout]{\label{fig:bhd-noise-electronics}blah}
\end{figure}
...
\begin{figure}
  ...
  \caption[Time series of the noise measured from the balanced homodyne readout electronics]{\label{fig:op-amp-noise-time-series}blah}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{graphics/generated/from-python/50-op-amp-noise-spectrum.pdf}
  \caption[Spectral density of the noise measured from the balanced homodyne readout electronics]{\label{fig:op-amp-noise-spectrum}blah}
\end{figure}
...
\begin{figure}
  ...
  \caption[Noise projection for \LMINUS{} using velocity feedback]{\label{fig:readout-noise-velocity}blah}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{graphics/generated/from-python/50-readout-noise-velocity-rms.pdf}
  \caption[Root-mean-square noise projection for \LMINUS{} using velocity feedback]{\label{fig:readout-noise-velocity-rms}blah}
\end{figure}
