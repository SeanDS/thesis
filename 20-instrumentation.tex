...
% hack with \left. and \right. to avoid issue with open brackets across a new line (http://latex-community.org/forum/viewtopic.php?f=46&t=4823)
\begin{equation}
  \label{eq:photodetector-beat-power}
  \begin{split}
    P = {E'}^2 = &{E'}_0^2 \left( \cos^2 \left( \omega_1 t \right) + \cos^2 \left( \omega_2 t \right) \right. \\
    &+ \left. \cos \left( \left( \omega_1 + \omega_2 \right) t \right) + \cos \left( \left( \omega_1 - \omega_2 \right) t \right) \right).
  \end{split}
\end{equation}
...
\sectionmark{The future of gravitational wave interferometry}
