...
\note{Explain DC readout is a type of homodyne. Also explain that you don't need to control the LO path or the alignment in this case - cite \cite{Fricke2012}.}

\note{Heterodyne suffers from cyclostationary shot noise and homodyne doesn't - results in sensitivity improvement of sqrt(1.5) - cite \cite{Niebauer1991}}

\note{From Tobin: A homodyne readout system differs from a heterodyne system by using a local oscillator at the same (optical) frequency as the field being measured.}
