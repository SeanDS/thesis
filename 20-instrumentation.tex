...
\note{See snippets for fluc. diss. theorem}
...
\note{Rana's thesis has some numbers for microseism etc.}
\note{From event instrument companion paper: These active platforms are used to reduce the very large displacements produced by tidal motion, due to the sun and the moon, and micro seismic activity. Tidal forces can produce displacements up to 100 um over a multi-kilometer baseline on time scales of hours; the micro seismic activity is driven by the ocean swell near the shore, and the resulting ground motion can be as large as several um at frequencies around 0.15 Hz - even far inland.}
