...
In order to calculate a response function for a set of optics, it is necessary to understand the propagation of a light field through vacuum and through optics. We define the field amplitude of light across time $t$ and space $x$ as:
\begin{equation}
  A = A_0 \text{e}^{\text{i} \omega t},
\end{equation}
for initial amplitude $A_0$ and $\omega = 2 \pi f$, where $f$ denotes frequency.
...
To be able to calculate the effect the motion
