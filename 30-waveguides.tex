...
\end{equation}
where $\theta$ is the \gls{ETM}'s (small) rotation angle and $\kappa$ is the cavity's coefficient of \gls{ETM} rotation to transverse \gls{WGM} spot motion.
