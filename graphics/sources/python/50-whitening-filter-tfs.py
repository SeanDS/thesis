...
# data path
data_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'data', 'generated', 'from-matlab', '50-whitening-filter-tfs.csv')
...
ax1.legend(['Input whitening', 'Output whitening'], loc='upper left')
