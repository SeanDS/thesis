...
ax1.vlines(0.08, 1e-6, 1e1, colors=colours.shades['black'], linestyles='dashed', zorder=2)
...
ax1.legend([r'PRC $-f_1$', r'PRC $+f_1$', r'SRC $-f_1$', r'SRC $+f_1$', r'PRC $-f_2$', r'PRC $+f_2$', r'SRC $-f_2$', r'SRC $+f_2$', r'ET-LF $L_{\mathrm{asy}}$'], loc='upper right', framealpha=lf.default_settings['legend.framealpha'])
