...
# data paths
data_path_local = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'data', '70-epics-aliasing-local.csv')
data_path_remote = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'data', '70-epics-aliasing-remote.csv')
