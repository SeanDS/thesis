...
# data paths
data_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'data', 'generated', 'from-matlab', '70-sideband-powers-vs-srcl-detuned.csv')
...
ax1.legend([r'PRC $-f_1$', r'PRC $+f_1$', r'SRC $-f_1$', r'SRC $+f_1$', r'PRC $-f_2$', r'PRC $+f_2$', r'SRC $-f_2$', r'SRC $+f_2$', r'ET-LF $L_{\mathrm{SRC}}$'], loc='lower right', framealpha=lf.default_settings['legend.framealpha'])
