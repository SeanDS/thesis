...
# data path
data_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'data', 'generated', 'from-matlab', '40-mich-vs-fp-mich-response.csv')
...
ax1.legend(['Michelson', 'Fabry-Perot Michelson'], loc='lower right')
