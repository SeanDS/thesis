...
d5 = ax.loglog(data_sensing[:, 0], total_velocity, color=colours.next(), lw=lf.LW_THICK, zorder=-1, alpha=lf.ALPHA_LINE_A)

leg = ax.legend(d1+d2+d3+d4+d5, ['Shot', 'Op-amp', 'ADC', 'Feedback', 'Total'])
