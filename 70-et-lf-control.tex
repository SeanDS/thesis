...
At this early stage, a reasonable control matrix can be determined through a heuristic approach building upon knowledge gained from the control of \ALIGO{}. As $f_2$ resonates in both recycling cavities, it 
...
\begin{table}
  ...
  \resizebox{16cm}{!}{%
	...
	\hline
	\textbf{\ASDC{}} & \num{4.66e+04} (\SI{0.00}{\degree}) & \textbf{\num{1.35e+09} (\SI{180.00}{\degree})} & \num{3.04e+05} (\SI{0.00}{\degree}) & \num{1.23e+05} (\SI{180.00}{\degree}) & \num{2.07e+05} (\SI{180.00}{\degree}) \\ 
	\textbf{\ASFIRST{}} & \num{1.82e+04} (\SI{-145.16}{\degree}) & \num{8.17e+07} (\SI{54.32}{\degree}) & \num{1.77e+04} (\SI{-120.23}{\degree}) & \num{1.29e+04} (\SI{112.32}{\degree}) & \num{1.26e+04} (\SI{56.30}{\degree}) \\ 
	\textbf{\ASSECOND{}} & \num{1.41e+06} (\SI{67.91}{\degree}) & \num{1.39e+09} (\SI{-143.51}{\degree}) & \num{2.83e+05} (\SI{132.25}{\degree}) & \num{3.52e+05} (\SI{-3.73}{\degree}) & \num{1.66e+05} (\SI{-160.99}{\degree}) \\ 
	\textbf{\ASSUM{}} & \num{1.67e+03} (\SI{119.66}{\degree}) & \num{4.50e+05} (\SI{-163.34}{\degree}) & \num{2.81e+04} (\SI{-88.73}{\degree}) & \num{5.12e+04} (\SI{103.63}{\degree}) & \num{4.61e+03} (\SI{-23.18}{\degree}) \\ 
	\textbf{\ASDIFF{}} & \num{1.19e+03} (\SI{39.56}{\degree}) & \num{2.08e+05} (\SI{178.46}{\degree}) & \num{3.34e+04} (\SI{-116.23}{\degree}) & \num{6.45e+04} (\SI{61.28}{\degree}) & \num{3.44e+03} (\SI{-146.33}{\degree}) \\ 
	\textbf{\POPDC{}} & \num{5.06e+02} (\SI{180.00}{\degree}) & \num{9.59e+04} (\SI{180.00}{\degree}) & \num{6.46e+03} (\SI{0.00}{\degree}) & \num{1.57e+04} (\SI{180.00}{\degree}) & \num{1.43e+02} (\SI{180.00}{\degree}) \\ 
	\textbf{\POPFIRST{}} & \num{5.98e+05} (\SI{-21.20}{\degree}) & \num{7.91e+03} (\SI{20.94}{\degree}) & \num{1.77e+05} (\SI{165.58}{\degree}) & \num{4.18e+05} (\SI{-14.35}{\degree}) & \num{5.14e+01} (\SI{-11.12}{\degree}) \\ 
	\textbf{\POPSECOND{}} & \num{4.14e+05} (\SI{90.03}{\degree}) & \num{6.16e+03} (\SI{-123.17}{\degree}) & \num{1.18e+05} (\SI{72.11}{\degree}) & \num{2.79e+05} (\SI{-110.33}{\degree}) & \num{1.07e+04} (\SI{110.96}{\degree}) \\ 
	\textbf{\POPSUM{}} & \num{3.00e+02} (\SI{-24.20}{\degree}) & \num{6.09e+00} (\SI{25.80}{\degree}) & \num{2.93e+03} (\SI{34.79}{\degree}) & \num{8.34e+03} (\SI{-145.34}{\degree}) & \num{1.07e+03} (\SI{-149.81}{\degree}) \\ 
