...
\chaptermark{Conceptual longitudinal sensing for ET-LF}
...
\sectionmark{Control of a dual-recycled Fabry-Perot Michelson}}
\sectionmark{Control of a dual-recycled Fabry-Perot Michelson}
...
We assume a modulation depth of \SI{0.1}{\radian} for $f_1$ and $f_2$ to keep the power in higher modulation orders low whilst allowing for a reasonable amount of light power in the first order. This parameter has little impact on others and can be tuned later to provide better separation between the two sideband signals on the sensors.
...
% Dirty hack to get this to display in a reasonable place
\clearpage
\begin{figure}[H]
  \centering
...
\begin{table}[htp]
  ...
  \resizebox{\columnwidth}{!}{%
    \begin{tabular}{r|c|c|c}
      ...
      First control sideband frequency & $f_1$ & \textemdash & \SI{11363101}{\hertz} \\
      Second control sideband frequency & $f_2$ & \textemdash & \SI{56815505}{\hertz} \\
