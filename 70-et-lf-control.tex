...
\begin{equation}
  \frac{h_{\SI{10}{\kilo\meter}}}{h_{\SI{4}{\kilo\meter}}} = \frac{\SI{10}{\kilo\meter}}{\SI{4}{\kilo\meter}} = 2.5,
\end{equation}
translating into an increase in the observable volume of the universe by around $15.6$, assuming that displacement noise sources stay the same.
