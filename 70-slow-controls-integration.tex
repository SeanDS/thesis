...
Make diagram to show timing lag (see Sebastian's comment in labbook 2016 05 24)

Show less glitches when threading is used to prevent wait time between samples
