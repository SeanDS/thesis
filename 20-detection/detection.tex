...
At \checkme{09:40:32 UTC} a gravitational wave passed through the LIGO \checkme{Hanford} detector, perturbing the mirrors by \checkme{\SI{10}{\nano\meter}} and causing a dark fringe offset large enough for the electronics controlling the interferometer to detect the ripple in spacetime more than \checkme{23} times above the noise. \checkme{Seven milliseconds} later, the same wave passed the LIGO \checkme{Louisiana} detector and moved the mirrors in the opposite direction. At that moment, the first gravitational wave in history had been detected.
