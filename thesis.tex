...
% for digital drafts
%\documentclass[twoside,nogutter]{sean-thesis}
% for final digital copy
\documentclass[twoside,nogutter,hidelinks]{sean-thesis}
% for printed copies
%\documentclass[twoside,hidelinks]{sean-thesis}
...
\begin{center}
  ...
  \begin{tabular}{ccl}
    ...
    1.1.0            & 2017-01-27    & Publication date \\
  \end{tabular}
  
  \vspace{3.5in}
  An electronic copy of the latest version of this work can be found at 
\url{https://attackllama.com/thesis/}.
\end{center}
