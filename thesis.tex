...
%%%
% Titling
% Access to title, author, etc. in the document (\maketitle clears the \@author, \@title, etc. macros)
\usepackage{titling}

% now set the title, etc. (this has to be done before hyperref sets it in the PDF metadata)
...
% generate the title (the macros are set above before hyperref)
\maketitle
