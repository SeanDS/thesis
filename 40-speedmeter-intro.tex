...
\begin{equation}
  \frac{O \left( f \right)}{h_{\left( - \right)}} = \frac{\text{e}^{\text{i} \beta \left( f \right)} \sqrt{2 \kappa}}{h_{\text{SQL}}}.
\end{equation}
...
\begin{equation}
  ...
  \end{pmatrix}.
\end{equation}
From this we can calculate the noise spectral density due to vacuum fluctuations at the input. Normal, unsqueezed vacuum has equal noise contributions in the cosine and sine quadratures, and so it is equal to the identity matrix:
\begin{equation}
  \vec{a}_{\text{vacuum}} =
  \begin{pmatrix}
   1 & 0 \\
